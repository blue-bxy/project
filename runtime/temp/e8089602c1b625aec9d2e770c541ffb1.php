<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\PHPNote\php_project\public/../application/admin\view\role\roleedit.html";i:1542248814;s:64:"D:\PHPNote\php_project\application\admin\view\public\header.html";i:1542340311;s:64:"D:\PHPNote\php_project\application\admin\view\public\footer.html";i:1542617006;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-row layui-col-space10 layui-form-item ">
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="title" lay-verify="required|rolename" placeholder="角色名称" class="layui-input " value="<?php echo $role['title']; ?>">
                    </div>
                </div>
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    <label class="layui-form-label">描述</label>
                    <div class="layui-input-block">
                        <textarea name="describe" placeholder="角色描述" lay-verify="required" class="layui-textarea" maxlength="200"><?php echo $role['describe']; ?></textarea>
                    </div>
                </div>
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    <div class="layui-input-block">
    ...
    layui.use(['form'], function() {
        ...
        form.verify({
            rolename:function(value,item){
                ...
                var checkResult = "";
                $.ajax({
                    url:"<?php echo url('Role/checkRole'); ?>",
                    type:'post',
