<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\PHPNote\php_project\public/../application/admin\view\user\editadmin.html";i:1542248814;s:64:"D:\PHPNote\php_project\application\admin\view\public\header.html";i:1542340311;s:64:"D:\PHPNote\php_project\application\admin\view\public\footer.html";i:1542617006;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-fluid layui-col-md12">
    <div class="layui-card">
        <div class="layui-card-body layui-form">
            <input type="hidden" name="id" id="uid" value="<?php echo $user['id']; ?>">
            <div class="layui-row layui-col-space10 layui-form-item ">
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    <label class="layui-form-label">名称</label>
                    <div class="layui-input-block">
                        <input type="text" name="username" lay-verify="required|username" placeholder="管理员名称" class="layui-input " value="<?php echo $user['username']; ?>">
                    </div>
                </div>
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    <label class="layui-form-label">头像</label>
                    <div class="layui-input-block">
                        <input type="hidden" id="data_photo" name="portrait" lay-verify="headCrop" value="<?php echo $user['portrait']; ?>">
                        <div id="fileList" class="uploader-list" style="float:right"></div>
                        <div  style="float:left" class="layui-btn" onclick="wk.layer_show1('上传头像',$('#headCrop'),700);">选择头像</div>
                        <img id="img_data" class="layui-circle layui-head-img" src="<?php echo $user['portrait']; ?>" onerror="this.src='/static/admin/images/head_default.gif'"/>
                    </div>
                </div>
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="real_name" lay-verify="required|realname" placeholder="管理员真实姓名" class="layui-input " value="<?php echo $user['real_name']; ?>">
                    </div>
                </div>
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    <label class="layui-form-label">联系方式</label>
                    <div class="layui-input-block">
                        <input type="text" name="phone" lay-verify="required|phone" placeholder="管理员联系方式" class="layui-input " value="<?php echo $user['phone']; ?>">
                    </div>
                </div>
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    <div class="layui-input-block">
...
<script>
    layui.use(['form'], function() {
        ...
        form.on('submit(component-form-element)', function (data) {
            layer.prompt({
                formType: 1
                , title: '敏感操作，请验证超级管理员密码'
            }, function (value, index) {
                $.post("<?php echo url('User/adminEdit','type=checkPassword'); ?>",{oldpassword:value},function(res){
                    if(res.code == 100){
                        wk.error("密码错误");
                    }else{
                        layer.close(index);
