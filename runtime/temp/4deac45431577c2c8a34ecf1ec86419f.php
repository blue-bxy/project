<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\PHPNote\php_project\public/../application/admin\view\email\index.html";i:1542707087;s:64:"D:\PHPNote\php_project\application\admin\view\public\header.html";i:1542340311;s:64:"D:\PHPNote\php_project\application\admin\view\public\footer.html";i:1580708491;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="layui-form layui-form-pane">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" value="<?php echo config('smtp.server'); ?>" class="layui-input layui-disabled" disabled>
                            </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" value="<?php echo config('smtp.serverport'); ?>" class="layui-input layui-disabled" disabled>
                            </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" value="<?php echo config('smtp.usermail'); ?>" class="layui-input layui-disabled" disabled>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">邮箱登入密码</label>
                            <div class="layui-input-inline">
                                <input type="password"  value="<?php echo config('smtp.pass'); ?>" class="layui-input layui-disabled" disabled>
                            </div>
                        </div>
                        <div class="layui-form-item">
                ...
                <div class="layui-card-body">
                    ...
                    <div class="layui-form layui-form-pane">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="code" value="<?php echo GetRandCode(); ?>" class="layui-input layui-disabled" disabled>
                            </div>
                        </div>
                        <div class="layui-form-item">
