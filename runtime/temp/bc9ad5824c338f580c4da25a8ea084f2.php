<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\PHPNote\php_project\public/../application/admin\view\user\useredit.html";i:1542248814;s:64:"D:\PHPNote\php_project\application\admin\view\public\header.html";i:1542340311;s:64:"D:\PHPNote\php_project\application\admin\view\public\footer.html";i:1580708491;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-card-body layui-form">
            <div class="layui-row layui-col-space10 layui-form-item ">
                ...
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="phone" placeholder="管理员联系方式" lay-verify="required|phone" class="layui-input " value="<?php echo $user['phone']; ?>">
                    </div>
                </div>
                <div class="layui-form-item layui-col-md-offset1 layui-col-md8">
                    <div class="layui-input-block">
